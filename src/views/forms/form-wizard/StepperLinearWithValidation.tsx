...
const StepperLinearWithValidation = () => {
  ...
  const personalSubmit = () => {
    handlePersonalSubmit(onSubmit)
  }
  const socialSubmit = () => {
    handleSocialSubmit(onSubmit)
  }
  ...
  const getStepContent = (step: number) => {
    switch (step) {
      case 0:
        return (
          <form key={0} onSubmit={submitAccount}>
      ...
      case 1:
        return (
          <form key={1} onSubmit={personalSubmit}>
            <Grid container spacing={5}>
              <Grid item xs={12}>
                <Typography variant='body2' sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {steps[1].title}
      ...
      case 2:
        return (
          <form key={2} onSubmit={socialSubmit}>
            <Grid container spacing={5}>
              <Grid item xs={12}>
                <Typography variant='body2' sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {steps[2].title}
